...
public class RegisterEntryDaoImpl implements IRegisterEntryDao {
	...
	public List<BookingDetails> listReservedBooks() throws LMSException {
		List<BookingDetails> entries = null;
		try (Connection con = ConnectionProvider.DEFAULT_INSTANCE.getConnection();
			...
			entries = new ArrayList<BookingDetails>();
			while (rs.next()) {
				BookingDetails entry = new BookingDetails();
