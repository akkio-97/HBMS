...
public class AdminConsole {
	...
	public void listBooks() {
		try {
			List<Hotel> books = bookService.listBooks();
			if (books != null) {
				System.out.println("\tBcode\tStatus\tTitle");
				System.out.println("-----------------------------------------");
				for (Hotel book : books) {
					System.out
	...
	public void issueBook() {
		try {
			List<BookingDetails> entries = regEntryService.listReservedBooks();
			if (entries != null) {
				System.out.println("\tLogId\tStudId\tReservedOn\tBCode\tTitle");
				System.out
						.println("-----------------------------------------------------");
				for (BookingDetails entry : entries) {
				...
				BookingDetails regEntry = regEntryService.findEntry(logid);
	...
	public void returnBook() {
		try {
			List<BookingDetails> entries = regEntryService.listIssuedBooks();
			if (entries != null) {
